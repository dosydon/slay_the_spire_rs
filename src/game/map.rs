...
pub struct Map {
    ...
    /// Adjacency list representation: (floor, position) -> set of connected (floor, position)
    adjacency_list: HashMap<(u32, u32), HashSet<(u32, u32)>>,
}
...
impl Map {
    ...
    pub fn get_adjacency_list(&self) -> &HashMap<(u32, u32), HashSet<(u32, u32)>> {
        &self.adjacency_list
    }
}

...
impl CharacterBattleInfo {
    ...
    pub fn apply_vulnerable(&mut self, turns: u32) {
        self.vulnerable_turns = self.vulnerable_turns.max(turns);
    }
    ...
    /// Calculate damage output with strength bonus
...
mod tests {
    ...
    fn test_character_creation() {
        let character = CharacterBattleInfo::new(50, 3);
    ...
    fn test_damage_without_block() {
        let mut character = CharacterBattleInfo::new(50, 3);
